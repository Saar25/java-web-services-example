 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://saartako.org/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://saartako.org/", "HelloServiceImplService");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://saartako.org/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://saartako.org/", "HelloServiceImplPort"), HelloService.class, features);
    }
